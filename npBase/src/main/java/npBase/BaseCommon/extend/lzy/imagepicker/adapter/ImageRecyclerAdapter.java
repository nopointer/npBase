package npBase.BaseCommon.extend.lzy.imagepicker.adapter;
...
import npBase.BaseCommon.extend.lzy.imagepicker.ui.ImageBaseActivity;
...
import npBase.BaseCommon.extend.lzy.imagepicker.view.SuperCheckBox;
...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_CAMERA){
            return new CameraViewHolder(mInflater.inflate(R.layout.lzy_adapter_camera_item,parent,false));
        }
        return new ImageViewHolder(mInflater.inflate(R.layout.lzy_adapter_image_list_item,parent,false));
    }
