...
import npBase.BaseCommon.extend.lzy.imagepicker.adapter.ImagePageAdapter;
import npBase.BaseCommon.extend.lzy.imagepicker.bean.ImageItem;
import npBase.BaseCommon.extend.lzy.imagepicker.util.Utils;
import npBase.BaseCommon.extend.lzy.imagepicker.view.ViewPagerFixed;
...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lzy_activity_image_preview);
