package npBase.BaseCommon.extend.lzy.imagepicker.ui;
...
import npBase.BaseCommon.extend.lzy.imagepicker.DataHolder;
import npBase.BaseCommon.extend.lzy.imagepicker.ImageDataSource;
import npBase.BaseCommon.extend.lzy.imagepicker.ImagePicker;
import npBase.BaseCommon.extend.lzy.imagepicker.adapter.ImageFolderAdapter;
import npBase.BaseCommon.extend.lzy.imagepicker.adapter.ImageRecyclerAdapter;
import npBase.BaseCommon.extend.lzy.imagepicker.bean.ImageFolder;
import npBase.BaseCommon.extend.lzy.imagepicker.bean.ImageItem;
import npBase.BaseCommon.extend.lzy.imagepicker.util.Utils;
import npBase.BaseCommon.extend.lzy.imagepicker.view.FolderPopUpWindow;
import npBase.BaseCommon.extend.lzy.imagepicker.view.GridSpacingItemDecoration;
...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageRecyclerAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lzy_activity_image_grid);
        LogUtil.e("ImageGridActivity  onCreate");
...
//        mImageGridAdapter = new ImageGridAdapter(this, null);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
            if (checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                LogUtil.e("ImageGridActivity ImageDataSource 1");
                new ImageDataSource(this, null, this);
            } else {
                ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_PERMISSION_STORAGE);
            }
        } else {
            LogUtil.e("ImageGridActivity ImageDataSource 2");
            new ImageDataSource(this, null, this);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_PERMISSION_STORAGE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                LogUtil.e("ImageGridActivity ImageDataSource 3");
                new ImageDataSource(this, null, this);
            } else {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_ok) {
            ...
            LogUtil.e("ImageGridActivity 去裁剪");
...
//                    mImageGridAdapter.refreshData(imageFolder.images);
    ...
    public void onImagesLoaded(List<ImageFolder> imageFolders) {
        LogUtil.e("ImageGridActivity :" + new Gson().toJson(imageFolders));
